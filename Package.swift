...
let package = Package(
    ...
    products: [
        ...
        .library(name: "TreeSitterPropertiesQueries", targets: ["TreeSitterPropertiesQueries"]),
        .library(name: "TreeSitterPropertiesRunestone", targets: ["TreeSitterPropertiesRunestone"]),
    ...
    dependencies: [
        .package(path: "/Users/user/Works/sshui/Runestone")
    ],
    targets: [
        ...
        .target(name: "TreeSitterProperties", cSettings: [.headerSearchPath("src")]),
        .target(name: "TreeSitterPropertiesQueries", resources: [.copy("highlights.scm"), .copy("tags.scm")]),
        .target(name: "TreeSitterPropertiesRunestone", dependencies: ["Runestone", "TreeSitterProperties", "TreeSitterPropertiesQueries"]),
